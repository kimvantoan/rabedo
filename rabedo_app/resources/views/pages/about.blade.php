...
@section('title', 'About Us - Rabedo')

@section('content')
<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
    <div class="bg-white px-6 py-10 shadow-sm sm:rounded-lg sm:p-12 mb-8 border border-gray-100">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900 mb-8 text-center">About Rabedo</h1>
        
        <div class="prose prose-lg mx-auto text-gray-600">
            <p><strong>Rabedo</strong> is an online travel news and media platform developed by <strong>KOLSUP LIMITED</strong>. Our goal is to help users easily discover travel inspiration, read in-depth guides, and stay updated with the latest tourism trends in a fast, transparent, and comprehensive way.</p>
            ...
            <ul>
                ...
                <li>Provide the best insights by reviewing destinations and optimizing travel data</li>
                <li>Apply cutting-edge technology and AI to personalize reading experiences for every user</li>
            </ul>
            ...
            <ul>
                ...
                <li>Inspirational travel guides suited for every itinerary</li>
            ...
            <ul>
                ...
                <li>Recommend suitable destinations using artificial intelligence</li>
            ...
            <ul>
                ...
                <li>Provide multidimensional comparisons of various choices</li>
            ...
            <ul>
                ...
                <li>Always putting the user experience at the center</li>
            </ul>
