    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3">
            ...
            <div class="mb-4 bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                <form action="{{ route('users.show', $user->id) }}" method="GET" class="flex items-center">
                    ...
                    @if(request('search'))
                        <a href="{{ route('users.show', $user->id) }}" class="ml-3 inline-flex justify-center py-2 px-4 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white border border-gray-300 hover:bg-gray-50">Xoá lọc</a>
                    @endif
                </form>
            </div>
