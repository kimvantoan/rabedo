...
<div class="mx-auto max-w-5xl px-4 py-8 sm_px-6 lg_px-8">
    <div class="mb-6 flex items-center justify-between">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('users.index') }}" class="text-sm font-medium text-gray-600 hover_text-gray-900 px-4 py-2">
                &larr; Quay lại
            </a>
            <a href="{{ route('users.edit', $user->id) }}" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover_bg-indigo-700 transition">
                Sửa thông tin
            </a>
        </div>
    </div>

    <div class="grid grid-cols-1 lg_grid-cols-4 gap-6">
        <!-- User Information (Left Column) -->
        <div class="lg_col-span-1">
            <div class="overflow-hidden bg-white shadow sm_rounded-lg mb-8">
                <div class="px-4 py-5 sm_px-6">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Thông tin tài khoản</h3>
                </div>
                <div class="border-t border-gray-200 px-4 py-5 sm_p-0">
                    <dl class="sm_divide-y sm_divide-gray-200">
                        <div class="py-4 px-4 sm_px-6">
        ...
        <div class="lg_col-span-3">
            ...
            <div class="mb-4 bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                <form action="{{ route('users.show', $user->id) }}" method="GET" class="flex flex-wrap sm_flex-nowrap items-center gap-3">
                    ...
                    <div class="relative flex-grow max-w-[200px] w-full sm_w-auto">
                        <input type="date" name="date" value="{{ request('date') }}" title="Lọc theo ngày đăng bài" class="block w-full px-3 py-2 border border-gray-300 rounded-md leading-5 bg-white text-gray-700 focus_outline-none focus_ring-1 focus_ring-indigo-500 focus_border-indigo-500 sm_text-sm">
                    </div>
                    <div class="flex items-center gap-2 mt-2 sm_mt-0 w-full sm_w-auto">
                        ...
                        <a href="{{ route('users.show', $user->id) }}" class="inline-flex justify-center py-2 px-4 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white border border-gray-300 hover_bg-gray-50 whitespace-nowrap w-full sm_w-auto text-center">Xoá lọc</a>
                        @endif
                    </div>
                </form>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-300 bg-white">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-4 text-sm font-medium text-indigo-600 hover_text-indigo-900 max-w-[120px] sm_max-w-[180px] lg_max-w-[200px] truncate" title="{{ $article->title }}">
